    ...
    return (
        <footer className="glass-panel border-t border-black/5 dark:border-white/10 mt-auto z-10 relative">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-3">
                            <a
                                ...
                                className="flex items-center gap-3 text-neutral-600 dark:text-neutral-400 hover:text-black dark:hover:text-white transition-colors group p-2 rounded-lg hover:bg-black/5 dark:hover:bg-white/5 -ml-2"
                            >
                ...
                {/* Bottom Bar */}
                <div className="mt-12 pt-8 border-t border-black/5 dark:border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-neutral-500">
